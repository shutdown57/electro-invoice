  ...
  <b-navbar>
    ...
    <template slot="end">
      ...
      <b-navbar-dropdown class="rtld" label="محصولات">
        <b-navbar-item tag="router-link" :to="{ path: '/products/create' }">
          ایجاد محصول
        </b-navbar-item>
      ...
      <b-navbar-dropdown class="rtld" label="فاکتورها">
        <b-navbar-item tag="router-link" :to="{ path: '/invoices/create' }">
          ایجاد فاکتور
        </b-navbar-item>
      ...
      <b-navbar-dropdown class="rtld" label="مشتریان">
        <b-navbar-item tag="router-link" :to="{ path: '/clients/create' }">
          ایجاد مشتری
        </b-navbar-item>
